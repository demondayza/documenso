      ...
      <section className="mt-6 space-y-6">
        {(team.teamEmail || team.emailVerification) && (
          <Alert className="p-6" variant="neutral">
            <AlertTitle className="text-base">Team email</AlertTitle>
        ...
        {team.ownerUserId === session.user.id && (
          <>
            {isTransferVerificationExpired && (
              ...
              >
                <div className="mb-4 sm:mb-0">
                  <AlertTitle className="text-base">Transfer team</AlertTitle>
            ...
            >
              <div className="mb-4 sm:mb-0">
                <AlertTitle className="text-base">Delete team</AlertTitle>
