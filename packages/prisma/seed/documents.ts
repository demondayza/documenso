 ...
 * 1. Completed document with 2 recipients.
 * 2. Pending document with 1 recipient.
 * 3. Pending document with 4 recipients.
 * 4. Draft document with 3 recipients.
 * 5. Draft document with 2 recipients.
 *
 * Create 3 non team documents where the user is a team member:
 * 1. Completed document with 2 recipients.
 * 2. Pending document with 1 recipient.
 * 3. Draft document with 2 recipients.
 *
